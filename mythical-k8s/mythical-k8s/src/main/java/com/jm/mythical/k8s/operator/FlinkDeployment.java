...
package com.jm.mythical.k8s.operator;

import com.fasterxml.jackson.annotation.JsonInclude;
import com.fasterxml.jackson.databind.annotation.JsonDeserialize;
import com.jm.mythical.k8s.operator.spec.FlinkDeploymentSpec;
import com.jm.mythical.k8s.operator.status.FlinkDeploymentStatus;
