...
package com.jm.mythical.k8s.flink.operator.status;

import com.jm.mythical.k8s.flink.operator.lifecycle.ResourceLifecycleState;
import com.jm.mythical.k8s.flink.operator.spec.AbstractFlinkSpec;
import com.jm.mythical.k8s.flink.operator.spec.JobState;
...
public abstract class CommonStatus<SPEC extends AbstractFlinkSpec> {
    ...
    public ResourceLifecycleState getLifecycleState() {
        ReconciliationStatus<SPEC> reconciliationStatus = getReconciliationStatus();
