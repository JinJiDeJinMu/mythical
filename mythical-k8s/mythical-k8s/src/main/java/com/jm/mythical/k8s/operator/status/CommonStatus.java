...
package com.jm.mythical.k8s.operator.status;

import com.jm.mythical.k8s.operator.lifecycle.ResourceLifecycleState;
import com.jm.mythical.k8s.operator.spec.AbstractFlinkSpec;
import com.jm.mythical.k8s.operator.spec.JobState;
